<li class="list-group-item">
    <div class="row">
        ...
        <div class="col-xs-4 col-sm-3 col-md-5 col-lg-4 text-right">
            <?php
            echo $this->Html->link(
...
//            echo $this->Html->link(
//                    '<span class="glyphicon glyphicon-edit" aria-hidden="true"></span><span class="hidden-xs hidden-sm">&nbsp;upravit</span>', ['controller' => 'tasks', 'action' => 'edit', $data['Task']['id']], ['class' => 'btn btn-primary btn-xs', 'escape' => false]
//            );
